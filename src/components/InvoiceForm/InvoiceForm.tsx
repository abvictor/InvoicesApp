...
import {Invoice, InvoiceFormProps} from '../../@types/types'
import { invoiceSchema } from '../../helpers/formValidator'


const InvoiceForm = ({isOpen, handleClose}:InvoiceFormProps) => {
   const {register, handleSubmit: onSubmit, watch, formState: { errors }} = useForm({resolver: yupResolver(invoiceSchema)})
  ...
  return (
    ...
    <Box as='form' h="auto" bgColor="#141625" p="4" w="700px" onSubmit={onSubmit(handleSubmit)}>
        ...
        <Stack mt="4" p="4">
            ...
            <Flex gap="2">
              <Stack>
                  ...
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_from_city')}/>
                  <Text color="red.400">{errors?.bill_from_city?.message}</Text>
               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Post Code</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_from_post_code')}/>
                  <Text color="red.400">{errors?.bill_from_post_code?.message}</Text>
               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Country</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_from_contry')}/>
           ...
           <Input w="630px" h="12" bgColor="#1E2139" border="none" {...register('bill_to_client_name')}/>
           <Text color="red.400">{errors?.bill_to_client_name?.message}</Text>


           <Text fontSize="sm" color="white" mt="2">Client's Email</Text>

           <Input w="630px" h="12" bgColor="#1E2139" border="none" {...register('billToClientEmail')}/>
           <Text color="red.400">{errors?.bill_to_client_name?.message}</Text>


           <Text fontSize="sm" color="white" mt="2">Street Address</Text>

           <Input w="630px" h="12" bgColor="#1E2139" border="none" {...register('bill_to_street_address')}/>
           ...
           <Flex gap="2">
              <Stack>
                  <Text fontSize="sm" color="white" mt="2">City</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_to_city')}/>
                  <Text color="red.400">{errors?.bill_to_city?.message}</Text>

               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Post Code</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_to_post_code')}/>
                  <Text color="red.400">{errors?.bill_to_post_code?.message}</Text>
               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Country</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('bill_to_country')}/>
           ...
           <Box mt="4">
             ...
             <Flex gap="2">
              <Stack>
                  ...
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('item_name')}/>
                  <Text color="red.400">{errors?.item_name?.message}</Text>

               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Qty.</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('item_qty')}/>
                  <Text color="red.400">{errors?.item_qty?.message}</Text>
               </Stack>
               <Stack>
                  <Text fontSize="sm" color="white" mt="2">Price</Text>
                  <Input w="100%" h="12" bgColor="#1E2139" border="none" {...register('item_price')}/>
        ...
        <Flex justifyContent="space-between" mt="8">
            ...
            <Flex gap="2">
                <Button color="white" h="12" borderRadius="28" bgColor="#373b53">Save as Draft</Button>
                <Button color="white" h="12" borderRadius="28" bgColor="#7c5dfa" type='submit'>Save & Send</Button>
            </Flex>
        </Flex>
        </Stack>      
    </Box>
